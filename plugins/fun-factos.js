...
conn.reply(m.chat, `🌸 Buscando un facto En la mochila de ELYSSIA, espere un momento 👑...`, m)
...
"📖 Tu historia terminó en el prólogo.",
"🚀 Te quedaste en cuenta regresiva.",
"🌱 Fuiste semilla toda la vida.",
"⚡ Eras promesa; te quedaste en borrador.",
"🕯️ Nunca brillaste lo suficiente para saber si podías iluminar.",
"🏆 Renunciaste antes de tener algo que perder.",
"📦 Llegaste con talento, te fuiste con excusas.",
"🔒 Tu zona de confort ganó todas las partidas.",
"⚰️ Enterraste tus sueños por miedo a que murieran.",
"📚 Sabías qué hacer; nunca quisiste hacerlo.",
"🎯 El plan era perfecto, faltó ejecutarlo.",
"⏳ Perdiste por abandono antes que por derrota.",
"💀 El fracaso ni te conoció; te venció el intento.",
"🧠 Tu potencial fue más grande que tus resultados.",
"🪫 Te quedaste sin energía antes de empezar.",
"🌙 Soñaste tanto que olvidaste despertar.",
"🏃 Corriste de tus problemas y llegaste a ellos primero.",
"🚧 Construiste tus propios límites y luego les tuviste miedo.",
"📉 Tu esfuerzo nunca alcanzó a tus expectativas.",
"🕳️ Caíste en agujeros que cavaste tú mismo.",
"🌫️ Te perdiste siguiendo caminos que nunca existieron.",
"🪞 Tu peor competencia siempre fue tu reflejo.",
"🎭 Fingiste tanto que olvidaste quién eras.",
"⚓ Te anclaste donde debías haber zarpado.",
"🌊 Esperaste la ola perfecta y nunca entraste al mar.",
"🔥 Te consumió el miedo antes que el fuego.",
"🧩 Tenías las piezas, pero nunca armaste el rompecabezas.",
"📍 Pasaste la vida preparándote para un momento que nunca llegó.",
"🪂 Nunca saltaste y aun así temías caer.",
"🚪 Esperaste oportunidades tocando puertas que jamás buscaste.",
"⏰ Siempre fue demasiado pronto o demasiado tarde.",
"🎨 Tenías el lienzo, pero nunca pintaste nada.",
"🌟 Naciste con potencial, viviste con excusas.",
"💡 Tu chispa brilló… solo en tu imaginación.",
"📚 Aprendiste lecciones que nunca aplicaste.",
"🕰️ Siempre llegaste tarde a tu propio éxito.",
"🪫 Eres la versión beta de ti mismo.",
"🌪️ Tus problemas siempre te alcanzan antes que tus soluciones.",
"🪞 Te miraste al espejo y viste lo que no quisiste ser.",
"🏗️ Construiste castillos de aire que nunca tocaron el suelo.",
"🛑 Tu miedo es más rápido que tus pasos.",
"🎯 Apuntaste alto, pero nunca disparaste.",
"🧭 Tu brújula interna se perdió hace años.",
"⏳ Te quedaste esperando que la vida comenzara sola.",
"📉 Cada intento fallido es un recuerdo de que no lo intentaste del todo.",
"🧱 Eres el muro que bloquea tus propios sueños.",
"💬 Tu voz se pierde antes de ser escuchada.",
"🌫️ Te nublaste a ti mismo antes de despejar el camino.",
"🪐 Orbitas alrededor de tus problemas sin resolver ninguno.",
"⚡ La energía que tenías se disipó en excusas.",
"🎭 Siempre actuaste, pero nunca fuiste real.",
"🚶 Caminaste mucho, pero nunca avanzaste.",
"🖼️ Pintaste paisajes que nadie pudo ver.",
];